...
st.write("# Welcome to Kevin 의  유트브 챗봇 ! 👋")
...
with st.sidebar:
     ...
     st.markdown(
      """
          ...
          - [나도 누구인가 ](https://kevinoh-whoami.streamlit.app/)
          ...
          - [트라우마 극복하기 ](https://kevinoh-trauma2.streamlit.app/)
          - [우환 때문에 산다 ](https://www.youtube.com/watch?v=0FV7rqP06c8)
          
          - [Body Language 알아채기 ](https://kevinoh-bodylanguage.streamlit.app/)
          - [NZ 쿠르즈 여행기 ](https://kevinoh-nzcruise.streamlit.app/)
          - [2026 REM workshop ]( https://kevin-rem209.streamlit.app/)
...
st.markdown(
    """
    살다 보면 즐거운 일도 있지만 말못할 고민이 있게 됩니다.
    사람한태 물어 보가 힘들때   
